    ...
    <section className="py-16 px-4 lg:px-0">
        <div className="container mx-auto text-center mb-10 relative">
            ...
            <p className="text-lg text-gray-600 mb-8">
                Discover the latest styles straight off the runaway, freshly added to keep your wardrobe on the cutting edge of fashion.
            </p>
            {/*Scroll Buttons */}
        ...
        onMouseLeave={handleMouseUpOrLeave}>
            {newArrivals.map((product) =>  (
                <div key={product._id} className="min-w-[100%] lg:min-w-[30%] relative">
                    <img 
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-opacity-50 backdrop-blur-md text-white p-4 rounded-b-lg">
                        ...
                        <h4 className="font-meduium">{product.name}</h4>
